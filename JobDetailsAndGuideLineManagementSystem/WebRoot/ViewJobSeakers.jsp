                  ...
                  <tr><td align="center">
                      <%
                       ...
                       <%
                         ...
                         ArrayList<UserMasterBean> jobSeakersList=userMasterDAO.viewJobSeakers(storepath);
                         if(jobSeakersList.size()!=0){
                           
                        %>
                    <table align="center" border="1">
                    <tr>
                      <td colspan="6" align="center"><font color="white"><b>Job Seakers Details</b></font></td>
                    </tr>
                    <tr>
                      ...
                      <td><font color="white">Photo</font></td>
                       ...
                       <%
                         for(UserMasterBean userMasterBean:jobSeakersList){
                        %>
                       <tr>
                    ...
                    <%}else { %>
                      <font color="white">Job Seakers Records Not found</font>
                      <%} %>
                  </td></tr>
                </table>
            </td>
