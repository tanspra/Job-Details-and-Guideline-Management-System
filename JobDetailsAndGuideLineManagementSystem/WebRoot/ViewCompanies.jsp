                  ...
                  <tr><td align="center">
                      <%
                       ...
                       <%
                         ...
                         ArrayList<CompanyMasterBean> companyList=companyDAO.viewCompanies(storepath,uid);
                         if(companyList.size()!=0){
                        %>
                    <table align="center" border="1">
                    <tr>
                      <td colspan="9" align="center"><font color="white"><b><%=(String)session.getAttribute("user") %> Companies</b></font></td>
                    </tr>
                    <tr>
                      ...
                      <td><font color="white">LoactionMap</font></td>
                       <td><font color="white">PostJobs</font></td>
                       </tr>
                       <%
                      ...
                      <td><img src="images/<%=companyMasterBean.getCompanylocationmap() %>" width="50" height="50" ></td>
                       <td><a href="CompanyJobsOpen.jsp?cid=<%=companyMasterBean.getCompanyid() %>">PostJobs</a></td> 
