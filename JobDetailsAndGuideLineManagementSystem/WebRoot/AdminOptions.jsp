...
function mmLoadMenus() {
  ...
  mm_menu_1224101012_0.addMenuItem("Register Employers","location='UserMaster.jsp'");
  mm_menu_1224101012_0.addMenuItem("ViewEmployers","location='ViewEmployers.jsp'");
    mm_menu_1224101012_0.addMenuItem("Post Emails","location='Email.jsp'");
   mm_menu_1224101012_0.addMenuItem("View Emails","location='ViewEmails.jsp'");
  mm_menu_1224101012_0.addMenuItem("PostFAQs","location='FAQs.jsp'");
   mm_menu_1224101012_0.addMenuItem("View FAQs","location='ViewFAQs.jsp'");
...
window.mm_menu_1224101649_0 = new Menu("root",134,25,"Georgia, Times New Roman, Times, serif",12,"#993333","#333366","#B6B6B6","#E7D398","left","middle",3,0,500,-5,7,true,false,true,0,true,false);
  mm_menu_1224101649_0.addMenuItem("Post News","location='News.jsp'"); 
   mm_menu_1224101649_0.addMenuItem("ViewNews","location='ViewNews.jsp'"); 
   
     mm_menu_1224101649_0.addMenuItem("Register Category","location='CategoryMaster.jsp'");
    mm_menu_1224101649_0.addMenuItem("View Categories","location='ViewCategories.jsp'");
   mm_menu_1224101649_0.addMenuItem("PostSampleResumes","location='SampleResume.jsp'");
    mm_menu_1224101649_0.addMenuItem("ViewSampleResumes","location='ViewSampleResumes.jsp'");
   ...
   mm_menu_1224101802_0.addMenuItem("ViewCompanies","location='ViewAllCompanies.jsp'");
   mm_menu_1224101802_0.addMenuItem("ViewAllJobOpenings","location='ViewAllJobs.jsp'");
   mm_menu_1224101802_0.addMenuItem("ViewJobSeakeres","location='ViewJobSeakers.jsp'");
   // mm_menu_1224101802_0.addMenuItem("ViewNewsPostings","location='ViewNewsPostings.jsp'");
   // mm_menu_1224101802_0.addMenuItem("NewsPosting","location='NewsPosting.jsp'");
  ...
  mm_menu_1224101903_0.addMenuItem("ViewProfile","location='ViewPersonalProfile.jsp'");
...
<a href="#" class="style1" name="link6" id="link2" onMouseOver="MM_showMenu(window.mm_menu_1224101649_0,0,25,null,'link6')" onMouseOut="MM_startTimeout();" >News</a>&nbsp;&nbsp;|
  <a href="#" class="style1" name="link5" id="link3" onMouseOver="MM_showMenu(window.mm_menu_1224101802_0,0,25,null,'link5')" onMouseOut="MM_startTimeout();">Company</a>&nbsp;&nbsp;|
