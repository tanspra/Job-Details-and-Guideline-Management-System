           ...
           <td><table align="center" width="970" height="450" bgcolor="9966as" >
                  <tr><td align="center">
                      <%
                       ...
                       <%} %>
                       <font color="white"><b>View Companies By Employers</b></font>
                       <form name="viewcompaniesbyemployee" action="ViewCompaniesByEmployers.jsp">
                       <table align="center" >
                       <tr>
                          <td><font color="white">Employer</font></td>
                          <td>
                          <select name="eid">
                          <option value="select">select</option>
                          <%
                             UserMasterDAO userMasterDAO=new UserMasterDAO();
                             ArrayList<UserMasterBean> employersList=userMasterDAO.getEmployers();
                       ...
                       <%
                        if(request.getParameter("eid")!=null){
                         ...
                         ArrayList<CompanyMasterBean> companyList=companyDAO.viewCompanies(storepath,eid);
